...
namespace OfficeCore.Excel.Attributes
{
    ...
    public class ExcelAttribute : Attribute
    {
        ...
        /// <param name="ExcelType">必须继承 <see cref="OfficeCore.Excel.Service.IExcelTypeFormater">IExcelTypeFormater</see>,默认：<see cref="OfficeCore.Excel.Service.Impl.DefaultExcelTypeFormater">DefaultExcelTypeFormater</see> </param>
