...
namespace OfficeCore.Excel.Attributes
{
    ...
    public class ExcelColumnAttribute : Attribute
    {
        ...
        /// <param name="exportExcelType">导出Excel，必须继承 <see cref="IExcelExportFormater">IExcelExportFormater</see>,默认：<see cref="OfficeCore.Excel.Service.Impl.DefaultExcelExportFormater">DefaultExcelExportFormater</see></param>
