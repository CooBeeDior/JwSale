...
namespace JwSale.Api.Controllers
{
    ...
    public class JwSaleControllerBase : ControllerBase
    {
        ...
        //protected async Task<bool> RefreshWxInoAsync(string token, string wxId, string username = null, string password = null, string device = null, bool isRefresh = false)
        //{
        //    bool flag = false;
