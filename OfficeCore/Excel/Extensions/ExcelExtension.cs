...
namespace OfficeCore.Excel.Extensions
{
    ...
    public static class ExcelExtension
    {
        ...
        public static void AddPicture(this ExcelWorksheet worksheet, byte[] imageBytes, ExcelRangeBase cell, bool autofit)
        {
            ...
            {
                var picture = worksheet.Drawings.AddPicture($"image_{DateTime.Now.Ticks}", imageStream);
        ...
        public static List<KeyValuePair<PropertyInfo, ExcelColumnAttribute>> ToColumnDic(this Type @type)
        {
            ...
            {
                var attributes = o.GetCustomAttributes<ExcelColumnAttribute>();
                if (!attributes.Where(s => s.Ignore == true).Any())
                {
